...
%..................................................................................................................................................................................................................
            if mimj_at<0.35 && mimj_at>0.1 && (stat_at(poloz_at,1).Orientation<-60 || stat_at(poloz_at,1).Orientation>60) && FA_at>pr_fa_at
                ...
                if spt(sppol,1).Orientation<0 %wyznaczenie kÄ…ta dla imrotate
               	...
               	sp_fa=sprt(sprpol,1).Area/(spa*spb); %cz??? obszaru zaj?ta przez znak
...
%..................................................................................................................................................................................................................
      for i=1:-0.0001:0.7 % p?tla w?a?ciwego doboru progu
            ...
            B1 = bwareaopen(B, 50); % usuni?cie ma?ych obiektów
            ...
            FA=stat(polozenie,1).Area/(fa1*fa2); %cz??? obszaru zaj?ta przez znak
            ...
            if mimj<0.3 && mimj>0.1 && (stat(polozenie,1).Orientation<-60 || stat(polozenie,1).Orientation>60) && FA>pr_fa && stat(polozenie,1).Area>100 %wszystkie parametry wyznaczyÂ³am na podstawie masek zbioru uczÂ¹cego, oczywiscie z dodatkowym buforem bezpieczeÃ±stwa
                ...
                for z=(i-0.0001):-0.0001:0.7
                    ...
                    while tragedyjka==1
                        ...
                        bbt = bwareaopen(bbt_0, 50); %usuni?cie obszarów poni?ej 300 pikseli
                        bbtIL=bwlabel(bbt); % mo?e zosta? teoretycznie wi?cej ni? 1 obszar, wi?c sprawdzenie
                        bbts=regionprops(bbtIL,'Area','BoundingBox'); %po pierwsze orientacja do obrotu, ale te? powierzchnia, ?eby orientacja by?a barna od najwi?kszego obszaru
                        % odnalezienie najwi?kszego obszaru
                        bbtpol=find([bbts.Area] == max([bbts.Area]));
            ...
            while tragedyjka==1 
                ...
                bbt1 = bwareaopen(bbt, 50); % usuni?cie ma?ych obiektów
                bbtIL_OB=bwlabel(bbt1); % numerowanie pozostaÂ³ych obiektów
        ...
        for i=1:-0.0001:0.7 % p?tla w?a?ciwego doboru progu wersja z dylatacj?
            ...
            if mimj<0.4 && mimj>0.1 && (stat(polozenie,1).Orientation<-60 || stat(polozenie,1).Orientation>60) && FA>pr_fa && gugu>450 %wszystkie parametry wyznaczyÂ³am na podstawie masek zbioru uczÂ¹cego, oczywiscie z dodatkowym buforem bezpieczeÃ±stwa
                ...
                for z=(i-0.0001):-0.0001:0.7
                    ...
                    % obliczenie paramerów stat dla obrazu rozwa?anego
                    SN_0=im2bw(WYCINEK, z); %obraz binarny rozwa?any
                    SN = bwareaopen(SN_0, 10); %usuni?cie obszarów poni?ej 300 pikseli
                    ...
                    while tragedyjka==1
                        ...
                        % obliczenie paramerów stat dla obrazu rozwa?anego
                        bbt_0=im2bw(WYC, z); %obraz binarny rozwa?any
                        bbt = bwareaopen(bbt_0, 10); %usuni?cie obszarów poni?ej 300 pikseli
            ...
            while tragedyjka==1
                ...
                WYC=imcrop(R(eee,1).K1, bb_pow);
                bbt=im2bw(WYC,i); % progowanie na podstawie dynamicznego progu
                bbt1 = bwareaopen(bbt, 10); % usuni?cie ma?ych obiektów
